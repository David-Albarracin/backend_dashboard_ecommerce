...
-- CLIENTES
-- ************************************		
INSERT INTO customer (is_active, created_at, customer_id, employee_id, updated_at, document_number, first_name, first_surname, last_name, last_surname, document_type) VALUES(1, NOW(), 1, 1, NOW(), 'CC1234567890', 'Juan', 'Perez', 'Martinez', 'Gomez', 'CEDULA_CIUDADANIA'), (1, NOW(), 2, 2, NOW(), 'CC0987654321', 'Maria', 'Garcia', 'Rodriguez', 'Martinez', 'CEDULA_CIUDADANIA'), (1, NOW(), 3, 3, NOW(), 'CC1122334455', 'Luis', 'Rodriguez', 'Sanchez', 'Gomez', 'CEDULA_CIUDADANIA'), (1, NOW(), 4, 4, NOW(), 'CC2233445566', 'Ana', 'Fernandez', 'Hernandez', 'Soto', 'CEDULA_CIUDADANIA'), (1, NOW(), 5, 5, NOW(), 'CC3344556677', 'Carlos', 'Lopez', 'Jimenez', 'Castro', 'CEDULA_CIUDADANIA'), (1, NOW(), 6, 6, NOW(), 'CC4455667788', 'Sofia', 'Torres', 'Perez', 'Gomez', 'CEDULA_CIUDADANIA'), (1, NOW(), 7, 7, NOW(), 'CC5566778899', 'Miguel', 'Gomez', 'Hernandez', 'Vargas', 'CEDULA_CIUDADANIA'), (1, NOW(), 8, 8, NOW(), 'CC6677889900', 'Laura', 'Castro', 'Hidalgo', 'Moreno', 'CEDULA_CIUDADANIA'), (1, NOW(), 9, 9, NOW(), 'CC7788990011', 'Roberto', 'Sanchez', 'Lopez', 'Ruiz', 'CEDULA_CIUDADANIA'), (1, NOW(), 10, 10, NOW(), 'CC8899001122', 'Valeria', 'Vargas', 'Cordoba', 'Mendoza', 'CEDULA_CIUDADANIA'); 
