...
package pro.ddsr.backend_dashboard_ecommerce.customer.web;
...
import pro.ddsr.backend_dashboard_ecommerce.customer.domain.service.CustomerService;
...
public class CustomerController {
    ...
    @GetMapping
    public List<CustomerProjection> listCustomer(){
